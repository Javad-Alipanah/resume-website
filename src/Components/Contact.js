         ...
         <div className="row">
           ...
           <div id="message-warning"> Error boy</div>
            ...
            <aside className="four columns footer-widgets">
               ...
               <div className="widget widget_quotes">
                  <h4 className="widget-title">Favorite Quotes</h4>
                  <ul id="twitter">
                     <li>
                        <span>
                        Aus der Kriegsschule des Lebens. — Was mich nicht umbringt, macht mich stärker.
                        <br/><a href="https://en.wikipedia.org/wiki/What_does_not_kill_me_makes_me_stronger">Friedrich Nietzsche</a>
                        </span>
                     </li>
                     <li>
                        <span>
                        ...
                        <br/><a href="https://genius.com/Friedrich-nietzsche-the-birth-of-tragedy-chap-3-annotated">Silenus to Midas</a>
                        </span>
                     </li>
                  </ul>
		         </div>
